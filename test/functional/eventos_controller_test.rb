...
class EventosControllerTest < ActionController::TestCase
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post :create, evento: { data: @evento.data, descricao: @evento.descricao, horario: @evento.horario, local: @evento.local }
    end
  ...
  test "should update evento" do
    put :update, id: @evento, evento: { data: @evento.data, descricao: @evento.descricao, horario: @evento.horario, local: @evento.local }
    assert_redirected_to evento_path(assigns(:evento))
  end
